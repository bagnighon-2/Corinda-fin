...
function ResizableIframe({
  src,
  title,
}: ResizableIframeProps): JSX.Element {
...
function BookCard({
  ...
  return (
    <motion.div
      ...
      style={{
        background: `linear-gradient(135deg, ${book.glow}, transparent 70%)`,
      }}
    >
      <div className="relative bg-[#08080e] rounded-[15px] p-6 h-full flex flex-col overflow-hidden border border-white/5 group-hover:border-white/10 transition-colors duration-300">
        ...
        <div className="flex items-start justify-between mb-4">
          <span
            className={`text-[10px] px-2 py-0.5 rounded-full border font-medium uppercase tracking-widest ${book.tagColor}`}
          >
            {book.tag}
          </span>
        ...
        <h3
          className={`text-base font-semibold mb-1 text-transparent bg-clip-text bg-gradient-to-r ${book.color} leading-snug`}
        >
          {book.title}
        </h3>
        ...
        <div className="mt-5 flex items-center gap-3 no-navigate">
          ...
          >
            {showPreview ? (
              <RiEyeOffLine className="text-white/40 shrink-0" />
            ) : (
              <RiEyeLine className="text-white/40 shrink-0" />
            )}
          ...
          >
            <span
              className={`flex items-center gap-1.5 text-xs font-medium uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-r ${book.color} hover:opacity-80 transition-opacity`}
            >
  ...
  return (
    <div className="flex-1 w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-20 pb-12 text-center">
        ...
        >
          <p className="text-[10px] uppercase tracking-[0.5em] text-white/25 mb-5">
            Curated Archive
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 pb-24">
        ...
        >
          ...
          <span className="text-xs text-white/25 uppercase tracking-[0.4em]">
            The Collection
          </span>
      ...
      <section className="border-t border-white/5 bg-[#040409] py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <p className="text-[10px] uppercase tracking-[0.5em] text-purple-400/50 mb-4">
              Tony Corinda
            </p>
            ...
            <p className="text-white/30 text-sm max-w-xl mx-auto leading-relaxed mb-8">
              ...
              has its own dedicated site —
              visit, preview inline, or access
              emergency mirrors.
            </p>
